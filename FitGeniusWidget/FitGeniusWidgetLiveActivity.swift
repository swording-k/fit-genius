//
//  FitGeniusWidgetLiveActivity.swift
//  FitGeniusWidget
//
...
struct FitGeniusWidgetAttributes: ActivityAttributes {
...
struct FitGeniusWidgetLiveActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: FitGeniusWidgetAttributes.self) { context in
